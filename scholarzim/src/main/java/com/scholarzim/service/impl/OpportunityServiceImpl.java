...
public class OpportunityServiceImpl implements OpportunityService {
    ...
    public void createOpportunity(OpportunityRequest request, String providerEmail) {
        ...
        opportunity.setTargetField(request.getTargetField());

        opportunity.setTargetCountry(request.getTargetCountry());
    ...
    public List<Opportunity> getActiveOpportunities() {
        ...
        return opportunityRepository.findAll().stream()
                ...
                .filter(opp -> opp.getDeadline() == null

                        || !opp.getDeadline().isBefore(today))
    ...
    @Override
    public java.util.Optional<Opportunity> findById(@NonNull Long id) {
