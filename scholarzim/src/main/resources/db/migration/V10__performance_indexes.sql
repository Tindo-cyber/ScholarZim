...
CREATE INDEX IF NOT EXISTS idx_opportunities_provider_user_id
...
CREATE INDEX IF NOT EXISTS idx_saved_scholarships_user_id
    ON saved_scholarships (user_id);

CREATE INDEX IF NOT EXISTS idx_opportunities_provider_name
