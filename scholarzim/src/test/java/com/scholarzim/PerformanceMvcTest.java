...
class PerformanceMvcTest extends MvcIntegrationTestBase {
    ...
    void landingUsesLightweightPublicScripts() throws Exception {
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("public-shell.js?v=50")))
                .andExpect(content().string(containsString("performance.js?v=50")))
                ...
                .andExpect(content().string(not(containsString("app.js?v=50"))))
