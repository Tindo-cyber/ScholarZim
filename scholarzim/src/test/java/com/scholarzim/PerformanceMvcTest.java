...
class PerformanceMvcTest extends MvcIntegrationTestBase {
    ...
    void landingUsesLightweightPublicScripts() throws Exception {
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("public-shell.js?v=")))
                .andExpect(content().string(containsString("performance.js?v=")))
                .andExpect(content().string(containsString("production.css?v=")))
                ...
                .andExpect(content().string(not(containsString("app.js?v="))))
