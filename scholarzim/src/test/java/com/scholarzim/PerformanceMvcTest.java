...
class PerformanceMvcTest extends MvcIntegrationTestBase {
    ...
    void landingUsesLightweightPublicScripts() throws Exception {
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("public-shell.js?v=60")))
                .andExpect(content().string(containsString("performance.js?v=60")))
                ...
                .andExpect(content().string(not(containsString("app.js?v=60"))))
    ...
    void dashboardKeepsAppShellScripts() throws Exception {
        ...
        mockMvc.perform(get("/applicant/profile").with(MvcTestSupport.asApplicant(email)))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("app.js?v=60")))
                .andExpect(content().string(containsString("production.css?v=60")))
                .andExpect(content().string(containsString("defer")));
    }
}
