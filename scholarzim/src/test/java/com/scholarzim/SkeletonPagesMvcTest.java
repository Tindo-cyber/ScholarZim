...
class SkeletonPagesMvcTest extends MvcIntegrationTestBase {
    ...
    void dashboardRendersSkeletonShell() throws Exception {
        ...
        mockMvc.perform(get("/applicant/dashboard").with(MvcTestSupport.asApplicant(email)))
                ...
                .andExpect(content().string(containsString("sz-skeleton-dashboard")))
    ...
    @Test
    @WithMockUser(roles = "APPLICANT")
    void profileRendersSkeletonShell() throws Exception {
        ...
        mockMvc.perform(get("/applicant/profile").with(MvcTestSupport.asApplicant(email)))
                ...
                .andExpect(content().string(containsString("sz-skeleton-profile")))
                .andExpect(content().string(not(containsString("spinner-border"))));
    }

    @Test
    @WithMockUser(roles = "APPLICANT")
    void notificationsRendersSkeletonShell() throws Exception {
        ...
        mockMvc.perform(get("/notifications").with(MvcTestSupport.asApplicant(email)))
                ...
                .andExpect(content().string(containsString("sz-skeleton-notifications")))
                .andExpect(content().string(not(containsString("spinner-border"))));
    }

    @Test
    @WithMockUser(roles = "APPLICANT")
    void applicationsRendersSkeletonShell() throws Exception {
        ...
        mockMvc.perform(get("/my-applications").with(MvcTestSupport.asApplicant(email)))
                ...
                .andExpect(content().string(containsString("sz-skeleton-applications")))
                .andExpect(content().string(not(containsString("spinner-border"))));
    }

    @Test
    @WithMockUser(roles = "APPLICANT")
    void messagesRendersSkeletonShell() throws Exception {
        ...
        mockMvc.perform(get("/messages").with(MvcTestSupport.asApplicant(email)))
                ...
                .andExpect(content().string(containsString("sz-skeleton-messages")))
                .andExpect(content().string(not(containsString("spinner-border"))));
    }

    @Test
    void publicScholarshipsRendersSkeletonGrid() throws Exception {
        mockMvc.perform(get("/scholarships"))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("sz-page-shell")))
                .andExpect(content().string(containsString("sz-skeleton-scholarship-grid")))
                .andExpect(content().string(not(containsString("spinner-border"))));
    }

    @Test
    @WithMockUser(roles = "APPLICANT")
    void opportunitiesListRendersSkeletonGrid() throws Exception {
