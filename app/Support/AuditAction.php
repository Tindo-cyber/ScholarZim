...
final class AuditAction
{
    ...
    public const VIEW_APPLICANT_TRANSCRIPT = 'VIEW_APPLICANT_TRANSCRIPT';
    ...
    public const NOTIFICATION_DELIVERY_FAILED = 'NOTIFICATION_DELIVERY_FAILED';
    public const DOCUMENT_QUARANTINED = 'DOCUMENT_QUARANTINED';
    public const DOCUMENTS_PURGED = 'DOCUMENTS_PURGED';
    ...
    public const AWARD_APPLICATION = 'AWARD_APPLICATION';
